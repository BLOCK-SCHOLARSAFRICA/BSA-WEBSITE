        ...
        >
          <div className="flex flex-col items-center  gap-6 md:items-start md:pl[200px] md:pl-10 ">
            ...
            <p
              ...
              style={{ fontFamily: "Poppins" }}
            >
              Powered By Block-Scholars Africa(BSA) & Teen Girls In
              Blockchain(TGIB),  Block-Scholars Africa & Teen Girls in
              Blockchain proudly power AWDEC2025, championing inclusion,
              innovation, and the empowerment of young Africans-especially
              wome-in blockchain, technology, and the digital economy across
              Africa.
            </p>
          </div>
